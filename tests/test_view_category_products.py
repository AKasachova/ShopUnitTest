...
class TestViewCategoryProducts:
    def test_categories_are_visible(self, web_browser):
    ...
    def test_category_page_is_displayed(self, web_browser):
        Home(web_browser).scroll_to_kids_title_text()
        Home(web_browser).click_category_women()
        Home(web_browser).click_category_dress()
